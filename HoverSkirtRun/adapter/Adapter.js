window.Adapter = (function (exports) {
    ...
    class Adapter {
        ...
        init(designWidth, designHeight, logoWidth = 596, logoHeight = 256,cb= new Function(),type = "fixedwidth") {
			...
			var screenWidth = (window.innerWidth||document.body.clientWidth) * pixelRatio;
			var screenHeight = (window.innerHeight||document.body.clientHeight) * pixelRatio;
			var scaleX = screenWidth / designWidth;
			var scaleY = screenHeight / designHeight;
			if(type == "fixedwidth")
			{
				this.designWidth = designWidth;
				this.designHeight = Math.round(screenHeight / scaleX);
			}
			else
			{
				this.designWidth = Math.round(screenWidth / scaleY);
